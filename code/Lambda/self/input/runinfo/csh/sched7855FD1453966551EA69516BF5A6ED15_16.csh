#!/bin/csh
# -------------------------------------- 
# Script generated on Mon Mar 19 22:11:01 EDT 2018 by the STAR Unified Meta Scheduler 1.10.27 and submitted with:
# cd /star/u/jhai/Strange/fromPeng/input; condor_submit /star/u/jhai/Strange/fromPeng/input/runinfo/csh/sched7855FD1453966551EA69516BF5A6ED15_0_99.condor
# --------------------------------------
...
setenv FILEBASENAME "st_physics_adc_15095020_raw_4000035"
setenv FILELIST "/star/u/jhai/Strange/fromPeng/input/runinfo/list/sched7855FD1453966551EA69516BF5A6ED15_16.list"
setenv FILELIST_ALL "/star/u/jhai/Strange/fromPeng/input/runinfo/csh/sched7855FD1453966551EA69516BF5A6ED15.list"
setenv INPUTFILECOUNT "1"
setenv JOBID "7855FD1453966551EA69516BF5A6ED15_16"
setenv JOBINDEX "16"
setenv LOGGING "STD"
setenv REQUESTID "7855FD1453966551EA69516BF5A6ED15"
setenv SUBMITATTEMPT "1"
setenv SUBMITTINGDIRECTORY "/star/u/jhai/Strange/fromPeng/input"
setenv SUBMITTINGNODE "rcas6010.rcf.bnl.gov"
setenv SUBMIT_TIME "2018-03-20 02:11:01"
setenv SUMS_AUTHENTICATED_USER "jhai@rhic.bnl.gov"
setenv SUMS_USER "jhai"
setenv SUMS_nProcesses "100"
setenv SUMS_name "null"
setenv USEXROOTD "1"
setenv INPUTFILE0 "root://xrdstar.rcf.bnl.gov:1095//home/starreco/reco/AuAu_200_production_low_2014/ReversedFullField/P16id/2014/095/15095020/st_physics_adc_15095020_raw_4000035.MuDst.root"
...
echo "--------------------------------"
echo 'STAR Unified Meta Scheduler 1.10.27 we are starting in $SCRATCH :' `/bin/pwd`
echo "--------------------------------"
/bin/ls -l
...
# User command BEGIN ----------------------------->
		...
		set mainDir = /star/u/jhai/Strange/fromPeng/
...
# Copy output files (if any where specified)
    ...
    foreach file ( $SCRATCH/*.root )
         ...
         if ( -d $file ) then
            set cpCommand="/bin/cp -r $file /star/u/jhai/Strange/fromPeng/output/"
         else
            set cpCommand="/bin/cp -fp $file /star/u/jhai/Strange/fromPeng/output/"
         endif
